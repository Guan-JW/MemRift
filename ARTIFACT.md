...
- **License:** Apache-2.0 for the artifact; datasets and models retain their own
  licenses.
- **Archive:** pending archival URL and DOI. A Git hosting URL alone does not
  qualify for the ACM Artifact Available badge.
...
ACM Artifact Available badge. Record that DOI and the final source revision in
`CITATION.cff` before submission.
