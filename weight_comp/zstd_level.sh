...
# MODEL_PATH="/opt/models/hf/Llama-3.2-3B-Instruct"
# MODEL_PATH="/opt/models/hf/TinyLlama-1.1B-Chat-v1.0"
# MODEL_PATH="/opt/models/hf/gpt2"

# BASE_DIR="Llama-3.2-3B-Instruct-zstd-compressed-weights"
# BASE_DIR="TinyLlama-1.1B-zstd-compressed-weights"
# BASE_DIR="gpt2-zstd-compressed-weights"
BASE_DIR="Mistral-7B-zstd-compressed-weights"
mkdir -p "${BASE_DIR}"
for level in {1..1}; do
